...
})(
  {
    1: [
      function (require, module, exports) {
        ...
        var ps = require("../layout/main"),
          psInstances = require("../layout/plugin/instances");
      ...
      { "../layout/main": 7, "../layout/plugin/instances": 18 },
    ],
    2: [
      function (require, module, exports) {
        "use strict";
    ...
    9: [
      function (require, module, exports) {
        ...
        var d = require("../layout/lib/dom"),
          h = require("../layout/lib/helper"),
      ...
      { "../layout/lib/dom": 3, "../layout/lib/helper": 6, "./instances": 18 },
    ],
    10: [
      function (require, module, exports) {
        "use strict";

        var h = require("../layout/../layout/lib/helper"),
          instances = require("../layout/instances"),
          updateGeometry = require("../layout/update-geometry"),
          updateScroll = require("../layout/update-scroll");
      ...
      {
        "../layout/../layout/lib/helper": 6,
        "../layout/instances": 18,
        "../layout/update-geometry": 19,
        "../layout/update-scroll": 20,
      },
    ],
    11: [
      function (require, module, exports) {
        ...
        var d = require("../layout/../layout/lib/dom"),
          h = require("../layout/../layout/lib/helper"),
          instances = require("../layout/instances"),
          updateGeometry = require("../layout/update-geometry"),
          updateScroll = require("../layout/update-scroll");
    ...
    12: [
      function (require, module, exports) {
        ...
        var h = require("../layout/../layout/lib/helper"),
          d = require("../layout/../layout/lib/dom"),
          instances = require("../layout/instances"),
          updateGeometry = require("../layout/update-geometry"),
          updateScroll = require("../layout/update-scroll");
    ...
    13: [
      function (require, module, exports) {
        ...
        var instances = require("../layout/instances"),
          updateGeometry = require("../layout/update-geometry"),
          updateScroll = require("../layout/update-scroll");
      ...
      { "../layout/instances": 18, "../layout/update-geometry": 19, "../layout/update-scroll": 20 },
    ],
    14: [
      function (require, module, exports) {
        "use strict";
      ...
      { "../layout/instances": 18, "../layout/update-geometry": 19 },
    ],
    15: [
      function (require, module, exports) {
        "use strict";
    ...
    17: [
      function (require, module, exports) {
        ...
        var cls = require("../layout/lib/class"),
          h = require("../layout/lib/helper"),
          instances = require("./instances"),
    ...
    18: [
      function (require, module, exports) {
        ...
        var cls = require("../layout/lib/class"),
          d = require("../layout/lib/dom"),
          defaultSettings = require("./default-setting"),
          EventManager = require("../layout/lib/event-manager"),
          guid = require("../layout/lib/guid"),
          h = require("../layout/lib/helper");
